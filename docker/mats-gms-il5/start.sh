...
export KAFKA_SCHEMA_REGISTRY_SECURITY_PROTOCOL=TLSv1.2
export KAFKA_SCHEMA_REGISTRY_SSL_KEYSTORE_LOCATION="$SSL_KEYSTORE_LOCATION"
export KAFKA_SCHEMA_REGISTRY_SSL_KEYSTORE_PASSWORD="$SSL_KEYSTORE_PASS"
export KAFKA_SCHEMA_REGISTRY_SSL_KEYSTORE_TYPE=BCFKS
export KAFKA_SCHEMA_REGISTRY_SSL_TRUSTSTORE_LOCATION="$SSL_TRUSTSTORE_LOCATION"
export KAFKA_SCHEMA_REGISTRY_SSL_TRUSTSTORE_PASSWORD="$SSL_TRUSTSTORE_PASS"
export KAFKA_SCHEMA_REGISTRY_SSL_TRUSTSTORE_TYPE=BCFKS
export SPRING_KAFKA_PROPERTIES_SCHEMA_REGISTRY_SECURITY_PROTOCOL=TLSv1.2
export SPRING_KAFKA_PROPERTIES_SCHEMA_REGISTRY_SSL_KEYSTORE_LOCATION="$SSL_KEYSTORE_LOCATION"
export SPRING_KAFKA_PROPERTIES_SCHEMA_REGISTRY_SSL_KEYSTORE_PASSWORD="$SSL_KEYSTORE_PASS"
export SPRING_KAFKA_PROPERTIES_SCHEMA_REGISTRY_SSL_KEYSTORE_TYPE=BCFKS
