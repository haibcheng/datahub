...
export KAFKA_PROPERTIES_SECURITY_PROTOCOL=SSL
export KAFKA_PROPERTIES_SSL_KEYSTORE_LOCATION="$SSL_KEYSTORE_LOCATION"
export KAFKA_PROPERTIES_SSL_KEYSTORE_PASSWORD="$SSL_KEYSTORE_PASS"
export KAFKA_PROPERTIES_SSL_KEYSTORE_TYPE=BCFKS
export KAFKA_PROPERTIES_SSL_TRUSTSTORE_LOCATION="$SSL_TRUSTSTORE_LOCATION"
export KAFKA_PROPERTIES_SSL_TRUSTSTORE_PASSWORD="$SSL_TRUSTSTORE_PASS"
export KAFKA_PROPERTIES_SSL_TRUSTSTORE_TYPE=BCFKS
