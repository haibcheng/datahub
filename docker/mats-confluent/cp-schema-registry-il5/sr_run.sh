...
export SCHEMA_REGISTRY_SSL_ENABLED_PROTOCOLS=TLSv1.2
export SCHEMA_REGISTRY_LISTENERS=https://0.0.0.0:8082
export SCHEMA_REGISTRY_INTER_INSTANCE_PROTOCOL=https
